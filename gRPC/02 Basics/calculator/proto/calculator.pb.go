...
func (x *CalculatorRequest) GetOperand1() int32 {
	if x != nil {
		return x.Operand1
	}
	return 0
...
func (x *CalculatorRequest) GetOperand2() int32 {
	if x != nil {
		return x.Operand2
	}
	return 0
...
func (x *CalculatorResposne) Reset() {
	*x = CalculatorResposne{}
	if protoimpl.UnsafeEnabled {
...
func (x *CalculatorResposne) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*CalculatorResposne) ProtoMessage() {}

func (x *CalculatorResposne) ProtoReflect() protoreflect.Message {
	mi := &file_calculator_proto_msgTypes[1]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use CalculatorResposne.ProtoReflect.Descriptor instead.
func (*CalculatorResposne) Descriptor() ([]byte, []int) {
	return file_calculator_proto_rawDescGZIP(), []int{1}
}

func (x *CalculatorResposne) GetResult() int64 {
	if x != nil {
		return x.Result
	}
	return 0
...
var file_calculator_proto_rawDesc = []byte{
	...
	0x05, 0x52, 0x08, 0x6f, 0x70, 0x65, 0x72, 0x61, 0x6e, 0x64, 0x32, 0x22, 0x2c, 0x0a, 0x12, 0x43,
	0x61, 0x6c, 0x63, 0x75, 0x6c, 0x61, 0x74, 0x6f, 0x72, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x73, 0x6e,
	...
	0x0a, 0x09, 0x63, 0x61, 0x6c, 0x63, 0x75, 0x6c, 0x61, 0x74, 0x65, 0x12, 0x1d, 0x2e, 0x63, 0x61,
	...
	0x6f, 0x72, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x73, 0x6e, 0x65, 0x42, 0x38, 0x5a, 0x36, 0x67, 0x69,
...
var file_calculator_proto_goTypes = []interface{}{
	...
	(*CalculatorResposne)(nil), // 1: calculator.CalculatorResposne
}
var file_calculator_proto_depIdxs = []int32{
	0, // 0: calculator.CalculatorService.calculate:input_type -> calculator.CalculatorRequest
	1, // 1: calculator.CalculatorService.calculate:output_type -> calculator.CalculatorResposne
...
func file_calculator_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_calculator_proto_msgTypes[1].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*CalculatorResposne); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
